...
import com.tongbanjie.link.core.network.*;
...
public abstract class AbstractNettyServer implements Server {
	...
	protected static final ConcurrentHashMap<io.netty.channel.Channel, com.tongbanjie.link.core.network.Channel<io.netty.channel.Channel>> channels =
			new ConcurrentHashMap<Channel, com.tongbanjie.link.core.network.Channel<Channel>>();
